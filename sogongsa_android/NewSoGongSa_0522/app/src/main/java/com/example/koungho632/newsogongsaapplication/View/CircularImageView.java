...
/**
 * Created by NT-RC510 on 2016-05-03.
 */

/*
*   동그란 이미지 뷰를 만들기 위한 클래스
*/
...
public class CircularImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attributes.getBoolean(R.styleable.CircularImageView_civ_border, true)) {
            ...
            setBorderColor(attributes.getColor(R.styleable.CircularImageView_civ_border_color, getResources().getColor(R.color.sogongsa_Basic_Color)));
        }
